...
{   
   u8 idnumqianwei,idnumbaiwei,idnumshiwei,idnumgewei;
   	...
   	Write_1621(15,0x01);   //logo
      	Write_1621(10,0x04);   //"-"
       WriteAll_1621(8,num67Seg+2*5,2);	//œ‘ æ5
	

   idnumqianwei=idnum/1000;
   WriteAll_1621(18,num12345Seg+2*idnumqianwei,2);	//œ‘ æidnum∞Ÿ ˝Œª

   idnumbaiwei=(idnum%1000)/100;
   WriteAll_1621(20,num12345Seg+2*idnumbaiwei,2);	//œ‘ æidnum Æ ˝Œª

   idnumshiwei=(idnum%100)/10;
   WriteAll_1621(0,num12345Seg+2*idnumshiwei,2);	//œ‘ æidnum∏ˆ ˝Œª

   idnumgewei=idnum%10;
   WriteAll_1621(2,num12345Seg+2*idnumgewei,2);	//œ‘ æidnum∏ˆ ˝Œª
}
